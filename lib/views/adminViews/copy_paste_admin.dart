...
class AdminCopyPastePage extends StatefulWidget {
  const AdminCopyPastePage({super.key});

  @override
  State<AdminCopyPastePage> createState() => _AdminCopyPastePageState();
}

class _AdminCopyPastePageState extends State<AdminCopyPastePage> {
  ...
  Widget build(BuildContext context) {
    ...
    final Stream<QuerySnapshot> adminsCopyPaste = FirebaseFirestore.instance
        .collection("Admin")
        .doc("@dm!n3000")
        .collection("CopyPaste")
