...
class AddAdminMedia extends StatefulWidget {
  final String collectionReference;
  final String textTag, mediaTag, routeName;
  const AddAdminMedia(
      {super.key,
  ...
  @override
  State<AddAdminMedia> createState() => _AddAdminMediaState();
}

class _AddAdminMediaState extends State<AddAdminMedia> {
  File? _selectedImage;
  File? _selectedVideo;
          ...
          child: MaterialButton(
            ...
            onPressed: () async {
              ...
              if (_selectedImage != null) {
                ...
                await storage.uploadAdminMedia(path2, fileName).then(
                    (value) => devtools.log("<<<<<Upload Image done>>>>"));

                await newsCollection.add({
                  widget.textTag: caption,
                  widget.mediaTag: fileName,
                  ...
                  if (widget.routeName == homeRoute ||
                      widget.routeName == adminHomeRoute) {
                    await Navigator.of(context).pushNamedAndRemoveUntil(
                        widget.routeName, (route) => false);
                  } else {
                ...
                final fileName = basename(path2!);
                await uploadAdminMediaVideos(
                    context, path2, fileName, widget.routeName);
  ...
  Future<void> uploadAdminMediaVideos(
      ...
      switch (snapshot.state) {
        ...
        case TaskState.success:
          await FirebaseStorage.instance
            ...
            if (routeName == homeRoute || routeName == adminHomeRoute) {
