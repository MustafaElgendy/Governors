...
class UserCharityView extends StatefulWidget {
  const UserCharityView({super.key});

  @override
  State<UserCharityView> createState() => _UserCharityViewState();
}

class _UserCharityViewState extends State<UserCharityView> {
