...
class UserDiscountsView extends StatefulWidget {
  const UserDiscountsView({super.key});

  @override
  State<UserDiscountsView> createState() => _UserDiscountsViewState();
}

class _UserDiscountsViewState extends State<UserDiscountsView> {
  ...
  Widget build(BuildContext context) {
    var addDiscounts = FirebaseFirestore.instance
        .collection("Admin")
        .doc("@dm!n3000")
        .collection("Discounts");
    final Stream<QuerySnapshot> adminDiscounts = FirebaseFirestore.instance
        .collection("Admin")
        .doc("@dm!n3000")
        .collection("Discounts")
    ...
    CollectionReference updateDiscounts = FirebaseFirestore.instance
        .collection("Admin")
        .doc("@dm!n3000")
        .collection("Discounts");
            ...
            return ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                if (!map.containsKey(userId)) {
                  map.addAll({userId: -1});
                  updateDiscounts.doc(data.docs[index].id).update({
                    "likedBy": map,
                  });
                }
                          ...
                          child: MaterialButton(
                            onPressed: () async {
                              ...
                              if (map.containsKey(userId)) {
                                ...
                                if (userliked == -1) {
                                  map.addAll({userId: 1});
                                  updateDiscounts.doc(docId).update({
                                    "likedBy": map,
