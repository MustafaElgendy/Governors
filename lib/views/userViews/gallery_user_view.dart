...
class UserGalleryView extends StatefulWidget {
  const UserGalleryView({super.key});

  @override
  State<UserGalleryView> createState() => _UserGalleryViewState();
}

class _UserGalleryViewState extends State<UserGalleryView> {
  ...
  Widget build(BuildContext context) {
    final Stream<QuerySnapshot> adminGallery = FirebaseFirestore.instance
        .collection("Admin")
        .doc("@dm!n3000")
        .collection("Gallery")
