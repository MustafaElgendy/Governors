...
class UserRewardsView extends StatefulWidget {
  const UserRewardsView({super.key});

  @override
  State<UserRewardsView> createState() => _UserRewardsViewState();
}

class _UserRewardsViewState extends State<UserRewardsView> {
