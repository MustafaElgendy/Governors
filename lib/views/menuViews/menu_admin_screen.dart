              ...
              onPressed: () async {
                switch (index) {
                  case 0:
                    print("0");
                  case 1:
                    await Navigator.of(context).pushNamed(chatAdminRoute);
                  case 2:
                    await Navigator.of(context).pushNamed(rewardsAdminRoute);
                  case 3:
                    await Navigator.of(context).pushNamed(galleryAdminRoute);
                  case 4:
                    await Navigator.of(context).pushNamed(charityAdminRoute);
                  case 5:
                    await Navigator.of(context).pushNamed(copyPasteAdminRoute);
                  case 6:
                    await Navigator.of(context).pushNamed(discountAdminRoute);
                  case 7:
