...
class AdminVideoViewWidget extends StatefulWidget {
  const AdminVideoViewWidget({
    super.key,
  ...
  @override
  State<AdminVideoViewWidget> createState() => _AdminVideoViewWidgetState();
}

class _AdminVideoViewWidgetState extends State<AdminVideoViewWidget> {
